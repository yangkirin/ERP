...
public class BomDetailEntity implements Serializable {
    ...
    private BigDecimal bomSumModiWgt;
    private BigDecimal bomSumNetWgt;
    private BigDecimal bomSumGrossWgt;
    ...
    public BigDecimal getBomSumModiWgt() {
        return bomSumModiWgt;
    }

    public void setBomSumModiWgt(BigDecimal bomSumModiWgt) {
        this.bomSumModiWgt = bomSumModiWgt;
    }

    public BigDecimal getBomSumNetWgt() {
        return bomSumNetWgt;
    }

    public void setBomSumNetWgt(BigDecimal bomSumNetWgt) {
        this.bomSumNetWgt = bomSumNetWgt;
    }

    public BigDecimal getBomSumGrossWgt() {
        return bomSumGrossWgt;
    }

    public void setBomSumGrossWgt(BigDecimal bomSumGrossWgt) {
        this.bomSumGrossWgt = bomSumGrossWgt;
    }

    public BigDecimal getPotWeight() {
        return potWeight;
    }

    public void setPotWeight(BigDecimal potWeight) {
