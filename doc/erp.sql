...
CREATE TABLE `bom_data` (
  ...
  `PRD_ID` bigint(20) DEFAULT NULL COMMENT '产品ID',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `MTR_CUT_ID` bigint(20) DEFAULT NULL COMMENT '切割形状ID',
  `MTR_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '原料类别',
  `TAKE_STN` bigint(20) DEFAULT NULL COMMENT '领料站点',
  `SEMI_FINISHED` varchar(255) DEFAULT NULL COMMENT '是否半成品',
  `GROSS_WGT` varchar(255) DEFAULT NULL COMMENT '材料毛重',
  `NET_WGT` varchar(255) DEFAULT NULL COMMENT '净重',
  `NET_RATE` varchar(255) DEFAULT NULL COMMENT '净得率',
  `MODI_WGT` varchar(255) DEFAULT NULL COMMENT '熟重',
  `MODI_RATE` varchar(255) DEFAULT NULL COMMENT '熟得率',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_USER` bigint(20) DEFAULT NULL COMMENT '创建者',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '创建日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配方信息表';
...
CREATE TABLE `bom_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `bom_id` bigint(20) DEFAULT NULL COMMENT '配方ID',
  `mtr_id` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `mtr_extend_id` bigint(20) DEFAULT NULL COMMENT '扩展规格ID',
  `mtr_extend_desc` varchar(255) DEFAULT NULL COMMENT '扩展规格说明[单位编码-单位名称-转换率]',
  `mtr_cut_id` bigint(20) DEFAULT NULL COMMENT '切割形状ID',
  `gross_wgt` varchar(255) DEFAULT NULL COMMENT '毛重',
  `net_wgt` varchar(255) DEFAULT NULL COMMENT '净重',
  `net_rate` varchar(255) DEFAULT NULL COMMENT '净得率',
  `modi_wgt` varchar(255) DEFAULT NULL COMMENT '熟重',
  `modi_rate` varchar(255) DEFAULT NULL COMMENT '熟得率',
  `price` decimal(10,2) unsigned DEFAULT NULL COMMENT '配方里原料的单价=原料采购价／采购转换率',
  `semi_finished` varchar(255) DEFAULT NULL COMMENT '是否半成品',
  `cost` decimal(10,2) unsigned DEFAULT NULL COMMENT '配方里原料的成本=（配方里原料单价／原料配方单位转换率',
  `cost_rate` decimal(10,2) unsigned DEFAULT NULL COMMENT '成本率=(成本／产品售价)*100%',
...
INSERT INTO `bom_detail` VALUES ('107', '21', '148', '0', '盒-1.000-¥:13.50', null, '1111.11', '1000', '0.900', '1000.00', '1.000', '13.50', '0', '13.50', '0.03', 'admin', '2018-02-01 16:48:34', null, null);
INSERT INTO `bom_detail` VALUES ('108', '21', '264', '0', '袋-17.500-¥:87.27', null, '500.00', '500', '1.000', '0.50', '0.001', '4.99', '0', '2.49', '0.01', 'admin', '2018-02-01 16:49:12', null, null);
INSERT INTO `bom_detail` VALUES ('110', '21', '8', '0', '壶-1-¥:1.20', null, '2.00', '200', '0.01', '2.00', '0.010', '1.20', '0', '2.40', '0.01', 'admin', '2018-02-01 18:05:33', 'admin', '2018-02-01 18:08:25');
INSERT INTO `bom_detail` VALUES ('111', '19', '8', null, null, '0', null, '400', null, '400.00', '1', null, '1', '1.98', '0.01', 'admin', '2018-02-01 18:09:49', 'admin', '2018-02-01 18:11:00');
...
CREATE TABLE `bom_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `bom_name` varchar(255) DEFAULT NULL COMMENT '配方名称',
  `bom_no` varchar(255) DEFAULT NULL COMMENT '配方编号',
  `bom_py` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `prd_id` bigint(20) DEFAULT NULL COMMENT '产品ID',
...
INSERT INTO `bom_info` VALUES ('19', '雪菜鸡丁炒饭', null, 'XCJDCF', '699', '1.98', '1', null, 'admin', '2018-02-01 16:36:37', null, null);
INSERT INTO `bom_info` VALUES ('20', '白米饭', null, '*BMF', '8', '1.98', '1', null, 'admin', '2018-02-01 16:38:28', null, null);
INSERT INTO `bom_info` VALUES ('21', '*腌制鸡丁5*5', null, 'AZJD5*5', '117', '18.39', '1', null, 'admin', '2018-02-01 16:45:12', null, null);
...
CREATE TABLE `mtr_cut` (
  ...
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `CUT` varchar(255) DEFAULT NULL COMMENT '加工形状',
  `WORK_HOURS` varchar(255) DEFAULT NULL COMMENT '工时',
  `NET_RATE` varchar(255) DEFAULT NULL COMMENT '净得率',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`ID`)
...
CREATE TABLE `mtr_data` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `MTR_CODE` varchar(255) DEFAULT NULL COMMENT '原料编号',
  `MTR_NAME` varchar(255) DEFAULT NULL COMMENT '原料名称',
  `MTR_PY` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `TYPE_ID` int(11) DEFAULT NULL COMMENT '类别',
  `CUT_ID` bigint(20) DEFAULT NULL COMMENT '切割形状',
  `PURCHASE_UNIT` varchar(255) DEFAULT NULL COMMENT '采购单位',
  `PURCHASE_RATE` varchar(255) DEFAULT NULL COMMENT '采购单位转换率',
  `MINI_UNIT` varchar(255) DEFAULT NULL COMMENT '最小单位',
  `MINI_RATE` varchar(255) DEFAULT NULL COMMENT '最小单位转换率',
  `FORMULA_UNIT` varchar(255) DEFAULT NULL COMMENT '配方单位',
  `MODI_RATE1` varchar(255) DEFAULT NULL COMMENT '净菜得率',
  `MODI_RATE2` varchar(255) DEFAULT NULL COMMENT '熟菜得率',
  `WAREHOUSE_ID` int(11) DEFAULT NULL COMMENT '所属仓库',
  `TAKE_STN_ID` int(11) DEFAULT NULL COMMENT '领料站点',
  `WGT_UNIT1` varchar(255) DEFAULT NULL COMMENT '单件重量',
  `WGT_UNIT2` varchar(255) DEFAULT NULL COMMENT '单筐重量',
  `PRICE` varchar(255) DEFAULT NULL COMMENT '采购单价',
  `FIXUP` varchar(255) DEFAULT NULL COMMENT '固定采购',
  `PURCYCLE` varchar(255) DEFAULT NULL COMMENT '采购周期',
  `COST_TYPE` varchar(255) DEFAULT NULL COMMENT '成本分类',
  `TAX_RATE` varchar(255) DEFAULT NULL COMMENT '税率',
  ...
  `UPDATE_USER` varchar(255) DEFAULT NULL,
  `UPDATE_DATE` datetime DEFAULT NULL,
  `EXTEND_CODE` varchar(255) DEFAULT NULL COMMENT '对外编码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1461 DEFAULT CHARSET=utf8 COMMENT='原料基础数据表';
...
INSERT INTO `mtr_data` VALUES ('8', '00000005', '料酒', 'LJ', '8', null, '108', '1', '46', '0.5', '47', '1.000', '0.010', '29', '58', '10.0', '7.0', '1.20', '1', '7', '15', '17.00', null, '', null, null, '1', null, null, 'admin', '2018-02-01 18:03:52', null);
...
INSERT INTO `mtr_data` VALUES ('609', 'BC000096', '罗森-奥尔良鸡排盖饭45*95mm', 'LS-AELJPGF45*95MM', '63', null, '61', '5000.000', '65', '1.000', '65', '1.000', '1.000', '30', '107', '0.0', '7.0', '0.070', '1', '7', '66', '17.00', null, '', null, null, '1', null, null, 'admin', '2017-12-18 23:36:47', null);
...
CREATE TABLE `prd_data` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `PRD_CODE` varchar(255) DEFAULT NULL COMMENT '产品编号',
  `PRD_NAME` varchar(255) DEFAULT NULL COMMENT '产品名称',
  `PRD_PY` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `TYPE_ID` int(11) DEFAULT NULL COMMENT '产品类别',
  `POT_WEIGHT` varchar(255) DEFAULT NULL COMMENT '锅重',
  `BOX_WEIGHT` varchar(255) DEFAULT NULL COMMENT '盒重',
  `REFERENCE_PRICE` varchar(255) DEFAULT NULL COMMENT '参考售价',
  `PROCESS` varchar(255) DEFAULT NULL COMMENT '生产工艺',
  `SEMI_FINISHED` varchar(255) DEFAULT NULL COMMENT '是否半成品:0-成品，1-半成品',
  `PDC_STN` int(11) DEFAULT NULL COMMENT '生产站点',
  `ORDER_TYPE` int(11) DEFAULT NULL COMMENT '订单类别',
  `EXTRA_COST` int(11) DEFAULT NULL COMMENT '额外成本',
  `COOK_TYPE` int(11) DEFAULT NULL COMMENT '烹调方式',
  `PRODUCTION_TIME` varchar(255) DEFAULT NULL COMMENT '单锅生产时间',
  `QUICK_COOLING` varchar(255) DEFAULT NULL COMMENT '是否速冷',
  `QUICK_COOLING_RATE` varchar(255) DEFAULT NULL COMMENT '速冷率',
  `ROUNDING` varchar(255) DEFAULT NULL COMMENT '是否取整',
  `ROUND_WEIGHT` varchar(255) DEFAULT NULL COMMENT '取整重',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_USER` varchar(20) DEFAULT NULL COMMENT '创建者',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '创建日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `REPORT_NO` bigint(20) DEFAULT NULL COMMENT '报表序',
  `UPDATE_DATE` datetime DEFAULT NULL,
  `UPDATE_USER` varchar(255) DEFAULT NULL,
  `EXTEND_CODE` varchar(255) DEFAULT NULL COMMENT '对外编码',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2063 DEFAULT CHARSET=utf8 COMMENT='产品基础信息';
...
CREATE TABLE `prd_nc_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `PRD_ID` bigint(255) DEFAULT NULL COMMENT '产品ID',
  `ENERGY` varchar(255) DEFAULT NULL COMMENT '能量／千焦',
  `ENERGY_NRV` varchar(255) DEFAULT NULL COMMENT '能量／NRV%',
  `PROTEIN` varchar(255) DEFAULT NULL COMMENT '蛋白质／克',
  `PROTEIN_NRV` varchar(255) DEFAULT NULL COMMENT '蛋白质／NRV%',
  `FAT` varchar(255) DEFAULT NULL COMMENT '脂肪／克',
  `FAT_NRV` varchar(255) DEFAULT NULL COMMENT '脂肪／NRV%',
  `CARBOHYDRATE` varchar(255) DEFAULT NULL COMMENT '碳水化合物／克',
  `CARBOHYDRATE_NRV` varchar(255) DEFAULT NULL COMMENT '碳水化合物／NRV%',
  `SODIUM` varchar(255) DEFAULT NULL COMMENT '钠／毫克',
  `SODIUM_NRV` varchar(255) DEFAULT NULL COMMENT '钠／NRV%',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_USER` bigint(20) DEFAULT NULL COMMENT '创建者',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '创建日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='产品营养成分信息';
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RenrenScheduler', 'yangzhendeMacBook-Pro-4.local1510813786470', '1510817254401', '15000');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_menu` VALUES ('93', '92', '仓库备货表', 'modules/businessPrint/stocking.html', null, '1', null, '1');
...
INSERT INTO `sys_menu` VALUES ('100', '92', '速冷作业表', '#', null, '1', null, '8');
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1407 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES ('1368', '1', '93');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '752f66996aea07aa83d17ff1ca4a7f2b', '2018-03-31 21:41:51', '2018-03-31 09:41:51');
...
CREATE TABLE `tb_customer_info` (
  ...
  `CUSTOMER_PY` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `CUSTOMER_SHORT_NAME` varchar(255) DEFAULT NULL COMMENT '简称',
  ...
  `UPDATE_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='客户信息';
...
CREATE TABLE `tb_customer_prd` (
  ...
  `PRD_ID` bigint(20) DEFAULT NULL COMMENT '产品ID',
  `PRD_NO` varchar(255) DEFAULT NULL COMMENT '产品编号',
  `PRD_PRICE` decimal(10,2) unsigned zerofill DEFAULT NULL COMMENT '产品售价',
  `TAG_SPEC` varchar(255) DEFAULT NULL COMMENT '标签规格',
  `TAG_NO` varchar(255) DEFAULT NULL COMMENT '标签编号',
  `TAG_CODE` varchar(255) DEFAULT NULL COMMENT '标签条码',
  `TAG_POWER` varchar(255) DEFAULT NULL COMMENT '加热时长',
  `TAG_PROD_TIME` varchar(255) DEFAULT NULL COMMENT '生产时间',
  `TAG_QGP` varchar(255) DEFAULT NULL COMMENT '保质期',
  `TAG_STORAGE` varchar(255) DEFAULT NULL COMMENT '储存条件',
  `TAG_NETWGT` varchar(255) DEFAULT NULL COMMENT '净含量',
  `TAG_PRICE` decimal(10,0) DEFAULT NULL COMMENT '标签价格',
  `TAG_ADDR` varchar(255) DEFAULT NULL COMMENT '地址',
  `TAG_PROD_ADDR` varchar(255) DEFAULT NULL COMMENT '产地',
  `TAG_MANUFACTURER` varchar(255) DEFAULT NULL COMMENT '制造商',
  `TAG_LINKPHONE` varchar(255) DEFAULT NULL COMMENT '联系电话',
  `TAG_BURDEN_LIST` varchar(255) DEFAULT NULL COMMENT '配料表',
  `TAG_LICENSE_NO` varchar(255) DEFAULT NULL COMMENT '许可编号',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `CREATE_USER` varchar(255) DEFAULT NULL,
  `CREATE_DATE` datetime DEFAULT NULL,
  ...
  `UPDATE_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='客户采购产品信息';
...
CREATE TABLE `tb_import` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `IMPORT_NO` varchar(255) DEFAULT NULL COMMENT '入库单号',
  `ORDER_ID` bigint(20) DEFAULT NULL COMMENT '订单ID',
  `SUPPLIER_ID` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `SUPPLIER_NAME` varchar(255) DEFAULT NULL COMMENT '供应商名称',
  `SUPPLIER_NO` varchar(255) DEFAULT NULL COMMENT '供应商编号',
  `IMPORT_DATE` datetime DEFAULT NULL COMMENT '入库日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `CREATE_USER` varchar(255) DEFAULT NULL COMMENT '入库人',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='入库主记录信息';
...
CREATE TABLE `tb_import_detail` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `IMPORT_ID` bigint(20) DEFAULT NULL COMMENT '入库单ID',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `MTR_NO` varchar(255) DEFAULT NULL COMMENT '原料编号',
  `IN_UNIT` varchar(255) DEFAULT NULL COMMENT '入库单位',
  `IN_RATE` varchar(255) DEFAULT NULL COMMENT '入库转换率',
  `ORDER_COUNT` varchar(255) DEFAULT NULL COMMENT '采购数量',
  `ORDER_PRICE` decimal(10,2) unsigned DEFAULT NULL COMMENT '采购单价',
  `ORDER_SUM_PRICE` decimal(10,2) unsigned DEFAULT NULL COMMENT '采购金额',
  `IN_COUNT` varchar(255) DEFAULT NULL COMMENT '入库数量',
  `IN_PRICE` decimal(10,2) unsigned DEFAULT NULL COMMENT '入库单价',
  `IN_SUM_PRICE` decimal(10,2) DEFAULT NULL COMMENT '入库金额',
  `ORDER_MTR_WGT` decimal(10,2) unsigned DEFAULT NULL COMMENT '采购原料件重',
  `IN_WGT` varchar(255) DEFAULT NULL COMMENT '入库重量',
  `IN_DATE` varchar(255) DEFAULT NULL COMMENT '入库日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 COMMENT='入库单明细信息';
...
CREATE TABLE `tb_import_mtr_batch` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `IMPORT_ID` bigint(20) DEFAULT NULL COMMENT '入库单ID',
  `IMPORT_DETAIL_ID` bigint(20) DEFAULT NULL COMMENT '入库明细ID',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `MTR_NAME` varchar(255) DEFAULT NULL COMMENT '原料名称',
  `MTR_NO` varchar(255) DEFAULT NULL COMMENT '原料编号',
  `EXTEND_ID` bigint(20) DEFAULT NULL COMMENT '原料扩展ID',
  `ORDER_UNIT_ID` bigint(20) DEFAULT NULL COMMENT '采购单位ID',
  `ORDER_UNIT_NAME` varchar(255) DEFAULT NULL COMMENT '采购单位',
  `ORDER_UNIT_RATE` decimal(10,2) DEFAULT NULL COMMENT '采购单位转换率',
  `ORDER_PRICE` decimal(10,2) DEFAULT NULL COMMENT '采购单价',
  `ORDER_COUNT` decimal(10,2) DEFAULT NULL COMMENT '采购数量',
  `IN_UNIT_ID` bigint(20) DEFAULT NULL COMMENT '入库单位ID',
  `IN_UNIT_NAME` varchar(255) DEFAULT NULL COMMENT '入库单位',
  `IN_UNIT_RATE` decimal(10,2) DEFAULT NULL COMMENT '入库单位转换率',
  `IN_PRICE` decimal(10,2) DEFAULT NULL COMMENT '入库单价',
  `IN_COUNT` decimal(10,2) DEFAULT NULL COMMENT '入库数量',
  `IN_UNIT1_COUNT` decimal(10,2) DEFAULT NULL COMMENT '入库件数',
  `WGT_UNIT1` decimal(10,2) DEFAULT NULL COMMENT '件重',
  `IN_WGT` decimal(10,2) DEFAULT NULL COMMENT '入库总重量',
  `IN_TOTLA_PRICE` decimal(10,2) DEFAULT NULL COMMENT '入库总金额',
  `BATCH_NO` varchar(255) DEFAULT NULL COMMENT '批次号',
  `PRODUCTION_DATE` datetime DEFAULT NULL COMMENT '生产日期',
  `EFFECTIVE_DATE` datetime DEFAULT NULL COMMENT '有效日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='入库原料批次信息';
...
CREATE TABLE `tb_mtr_extend` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `EXTEND_CODE` varchar(2) DEFAULT NULL COMMENT '扩展编号,同一个原料的扩展编号以00开始，依次进行累加',
  `UNIT_ID` bigint(20) DEFAULT NULL COMMENT '此规格采购单位',
  `UNIT_RATE` decimal(10,2) unsigned DEFAULT NULL COMMENT '此规格单位下的转换率',
  ...
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='原料扩展信息表';
...
CREATE TABLE `tb_order_detail` (
  ...
  `ORDER_ID` bigint(20) DEFAULT NULL COMMENT '订单ID',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `MTR_CODE` varchar(255) DEFAULT NULL COMMENT '原料编码',
  `MTR_NAME` varchar(255) DEFAULT NULL COMMENT '原料名称',
  `MTR_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '类型ID',
  `MTR_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '类型名称',
  `MTR_UNIT` varchar(255) DEFAULT NULL COMMENT '单位',
  `MTR_RATE` varchar(255) DEFAULT NULL COMMENT '转换率',
  `WAREHOSE_ID` bigint(20) DEFAULT NULL COMMENT '仓库ID',
  `WAREHOSE_NAME` varchar(255) DEFAULT NULL COMMENT '仓库名称',
  `WGT_UNIT1` varchar(255) DEFAULT NULL COMMENT '件重',
  `WGT_UNIT2` varchar(255) DEFAULT NULL COMMENT '盒重',
  `PURCHASE_NO` varchar(255) DEFAULT NULL COMMENT '采购编码',
  `AMOUNT` double(20,0) unsigned zerofill DEFAULT NULL COMMENT '采购数量',
  `IN_WGT` varchar(255) DEFAULT NULL COMMENT '入库重量',
  `IN_COUNT` varchar(255) DEFAULT NULL COMMENT '入库数量',
  `IN_PRICE` decimal(10,2) unsigned zerofill DEFAULT NULL COMMENT '入库单价',
  `PRICE` decimal(10,2) unsigned zerofill DEFAULT NULL COMMENT '价格',
  `COST_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '成分分类ID',
  `COST_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '成本分类名称',
  `CREATE_USER` varchar(255) DEFAULT NULL,
  `CREATE_DATE` datetime DEFAULT NULL,
  `UPDATE_USER` varchar(255) DEFAULT NULL,
  `UPDATE_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='订单明细信息';
...
INSERT INTO `tb_order_detail` VALUES ('40', '20', '100', '00000098', '大白菜', '100', '原料*蔬菜类', 'kg', '1.000', '28', '冷藏库', '', '', '00000098', '00000000000000000022', null, null, null, '00000001.80', '101', '蔬菜类', null, null, null, null);
INSERT INTO `tb_order_detail` VALUES ('42', '20', '1460', 'A0501460', '测试咖喱饭2215身', '62', '原料*包材', '件', '1.00', '26', '包材库', '0.5', null, 'A0501460', '00000000000000000004', '0.00', '0.00', '00000000.00', '00000378.00', '66', '包材', 'admin', '2018-01-25 21:26:12', 'admin', '2018-01-26 03:36:38');
...
CREATE TABLE `tb_order_info` (
  ...
  `SUPPLIER_ID` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `PROCUREMENT_ID` bigint(20) DEFAULT NULL COMMENT '计划ID',
  `EXCEPTION_DATE` varchar(255) DEFAULT NULL COMMENT '期望到货日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `CREATE_USER` varchar(255) DEFAULT NULL,
  `CREATE_DATE` datetime DEFAULT NULL,
  `UPDATE_USER` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `tb_order_info` VALUES ('13', '001', '9', null, '2017-12-23', '2', 'admin', '2017-12-22 05:49:38', null, null);
INSERT INTO `tb_order_info` VALUES ('14', '002', '9', null, '2017-12-24', '2', 'admin', '2017-12-22 05:56:12', null, null);
INSERT INTO `tb_order_info` VALUES ('15', '003', '9', null, '2017-12-25', '2', 'admin', '2017-12-25 20:32:15', null, null);
INSERT INTO `tb_order_info` VALUES ('18', '004', '9', null, '2018-01-26', '2', 'admin', '2018-01-23 15:43:44', 'admin', '2018-01-23 16:38:37');
INSERT INTO `tb_order_info` VALUES ('20', '005', '9', null, '2018-01-25', '1', 'admin', '2018-01-25 19:53:54', 'admin', '2018-01-25 23:37:06');
INSERT INTO `tb_order_info` VALUES ('21', '006', '9', null, '2018-03-31', '2', 'admin', '2018-03-30 11:57:17', null, null);
INSERT INTO `tb_order_info` VALUES ('22', '007', '9', null, '2018-03-31', '2', 'admin', '2018-03-30 14:07:20', null, null);
...
CREATE TABLE `tb_outport_detail` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `OUTPORT_NO` varchar(255) DEFAULT NULL COMMENT '出库单号',
  `ORDER_ID` bigint(20) DEFAULT NULL COMMENT '生产订单ID',
  `CUSTOMER_ID` bigint(20) DEFAULT NULL COMMENT '客户ID',
  `CUSTOMER_NAME` varchar(255) DEFAULT NULL COMMENT '客户名称',
  `CUSTOMER_NO` varchar(255) DEFAULT NULL COMMENT '客户编号',
  `PRD_ID` bigint(20) DEFAULT NULL COMMENT '产品ID',
  `PRD_NO` varchar(255) DEFAULT NULL COMMENT '产品编号',
  `PRD_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '产品类型',
  `PRD_NAME` varchar(255) DEFAULT NULL COMMENT '产品名称',
  `MTR_ID` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `MTR_NO` varchar(255) DEFAULT NULL COMMENT '原料编号',
  `MTR_NAME` varchar(255) DEFAULT NULL COMMENT '原料名称',
  `MTR_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '原料类型',
  `ORDER_COUNT` decimal(10,2) DEFAULT NULL COMMENT '需求数量',
  `OUT_COUNT` decimal(10,2) DEFAULT NULL COMMENT '领料数量',
  `BOM_GROSS_WGT` decimal(10,2) unsigned zerofill DEFAULT NULL COMMENT '配方原料毛重',
  `OUT_UNIT` varchar(255) DEFAULT NULL COMMENT '出库单位',
  `OUT_DATE` datetime DEFAULT NULL COMMENT '出库日期',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `CREATE_USER` varchar(255) DEFAULT NULL COMMENT '操作人',
  `BATCH_NO` varchar(255) DEFAULT NULL COMMENT '原料入库批次号',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='出库记录信息';

-- ----------------------------
-- Records of tb_outport_detail
-- ----------------------------
INSERT INTO `tb_outport_detail` VALUES ('1', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品', '86', '00000083', '土豆', '蔬菜类', '11.64', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('2', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品', '276', '00000278', '干辣椒', '干货', '0.50', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('3', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品', '2', '00000236', '酱油', '液态', '3.63', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('4', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '测试类半成品', '997', 'YR000013', '原味鸡块', '肉类', '3.30', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('5', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '测试类半成品', '264', '00000265', '腌制盐', '固态', '0.66', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('6', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '4', '00000000', '水', '原料', '1.49', null, null, '', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('7', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '267', '00000268', '土老憨生抽', '液态', '0.07', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('8', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '128', '00000128', '热干面（熟）', '米面类', '7.56', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('9', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '287', '00000290', '大豆油', '油脂类', '1.13', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('10', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品12', '86', '00000083', '土豆', '蔬菜类', '11.64', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('11', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '2', '00000236', '酱油', '液态', '1.98', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('12', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '997', 'YR000013', '原味鸡块', '肉类', '3.30', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('13', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '264', '00000265', '腌制盐', '固态', '0.66', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('14', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品12', '1460', 'A0501460', '测试咖喱饭2215身', '包材', '0.09', null, null, '件', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('15', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '4', '00000000', '水', '原料', '1.49', null, null, '', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('16', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '267', '00000268', '土老憨生抽', '液态', '0.07', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('17', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '128', '00000128', '热干面（熟）', '米面类', '7.56', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('18', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '287', '00000290', '大豆油', '油脂类', '1.13', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('19', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品12', '86', '00000083', '土豆', '蔬菜类', '11.64', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('20', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '2', '00000236', '酱油', '液态', '1.98', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('21', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '997', 'YR000013', '原味鸡块', '肉类', '3.30', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('22', 'L201712210007', '32', '3', '仓储', '0001', '2060', 'F010602060', '面类', '*测试类半成品2', '264', '00000265', '腌制盐', '固态', '0.66', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('23', 'L201712210007', '32', '3', '仓储', '0001', '2062', 'F010602061', '面类', '测试类产品12', '1460', 'A0501460', '测试咖喱饭2215身', '包材', '0.09', null, null, '件', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('24', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '4', '00000000', '水', '原料', '1.49', null, null, '', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('25', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '267', '00000268', '土老憨生抽', '液态', '0.07', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('26', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '128', '00000128', '热干面（熟）', '米面类', '7.56', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('27', 'L201712210007', '32', '3', '仓储', '0001', '55', '00000055', '面类', '热干面', '287', '00000290', '大豆油', '油脂类', '1.13', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('28', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '294', '00000297', '鸡蛋', '贸易类', '35.30', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('29', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '700', 'DPL00006', '咸蛋黄', '贸易类', '15.00', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('30', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '264', '00000265', '腌制盐', '固态', '5.00', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('31', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '287', '00000290', '大豆油', '油脂类', '15.00', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('32', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '294', '00000297', '鸡蛋', '贸易类', '35.30', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('33', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '700', 'DPL00006', '咸蛋黄', '贸易类', '15.00', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('34', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '264', '00000265', '腌制盐', '固态', '5.00', null, null, 'kg', null, null, null, null);
INSERT INTO `tb_outport_detail` VALUES ('35', 'L0001', '1', '5', '罗森', '0003', '5', '00000001', '饭卷', '三彩蛋卷', '287', '00000290', '大豆油', '油脂类', '15.00', null, null, 'kg', null, null, null, null);
...
CREATE TABLE `tb_procurement_detail` (
  ...
  `UNIT` varchar(255) DEFAULT NULL COMMENT '采购单位',
  `RATE` varchar(255) DEFAULT NULL COMMENT '转换率',
  `COUNT` decimal(10,0) DEFAULT NULL COMMENT '采购数量',
  `SPEC` varchar(255) DEFAULT NULL COMMENT '规格',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='采购计划明细';
...
CREATE TABLE `tb_procurement_plan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `PROCUREMENT_NO` varchar(255) DEFAULT NULL COMMENT '采购计划编号',
  `EXPECT_DATE` datetime DEFAULT NULL COMMENT '期望到货日期',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '制单日期',
  `CREATE_USER` varchar(255) DEFAULT NULL COMMENT '制单人',
  `SEND_DATE` datetime DEFAULT NULL COMMENT '发送日期',
  `CONFIRM_USER` varchar(255) DEFAULT NULL COMMENT '确认人',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='采购计划表';
...
CREATE TABLE `tb_production_order` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `PRODUCTION_NO` varchar(255) DEFAULT NULL COMMENT '生产订单编号',
  `PLAN_ID` bigint(20) DEFAULT NULL COMMENT '计划单ID',
  `PLAN_NO` varchar(255) DEFAULT NULL COMMENT '计划单编号',
  `ORDER_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '订单类型ID',
  `ORDER_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '订单类型名称',
  `CUSTOMER_ID` bigint(20) DEFAULT NULL COMMENT '客户ID',
  `CUSTOMER_NO` varchar(255) DEFAULT NULL COMMENT '客户编号',
  `CUSTOMER_NAME` varchar(255) DEFAULT NULL COMMENT '客户名称',
  `PLACE_ID` bigint(20) DEFAULT NULL COMMENT '售点ID',
  `PLACE_NAME` varchar(255) DEFAULT NULL COMMENT '售点名称',
  `REMAKR` varchar(255) DEFAULT NULL COMMENT '备注',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `CREATE_USER` varchar(255) DEFAULT NULL COMMENT '创建者',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '创建日期',
  `PRD_COST` decimal(10,2) unsigned zerofill DEFAULT NULL COMMENT '成本',
  `PRD_INCOME` decimal(10,0) DEFAULT NULL COMMENT '收入',
  `DISCOUNT_INCOME` decimal(10,0) DEFAULT NULL COMMENT '折后收入',
  `PRD_MOUNT` varchar(255) DEFAULT NULL COMMENT '产品总数',
  `COST_RATE` decimal(10,0) DEFAULT NULL COMMENT '成本率',
  `DISCOUNT_COST_RATE` decimal(10,0) DEFAULT NULL COMMENT '折扣成本比',
  `UPDATE_DATE` datetime DEFAULT NULL,
  `UPDATE_USER` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='生产订单信息表';

-- ----------------------------
-- Records of tb_production_order
-- ----------------------------
INSERT INTO `tb_production_order` VALUES ('1', '0001', null, null, '41', '鲜食', '5', '0003', '罗森', '83', '鲜食', null, '2', 'admin', '2018-02-05 10:48:42', null, null, null, null, null, null, '2018-02-05 12:43:07', 'admin');
INSERT INTO `tb_production_order` VALUES ('2', '0002', null, null, '42', '熟食', '5', '0003', '罗森', '83', '熟食', null, '2', 'admin', '2018-02-23 15:44:08', null, null, null, null, null, null, '2018-02-23 15:45:11', 'admin');
INSERT INTO `tb_production_order` VALUES ('3', '0003', null, null, '43', '企业团餐', '5', '0003', '罗森', '83', '企业团餐', null, '2', 'admin', '2018-02-24 01:31:05', null, null, null, null, null, null, '2018-02-24 01:33:17', 'admin');
INSERT INTO `tb_production_order` VALUES ('4', '0004', null, null, '43', '企业团餐', '3', '0001', '仓储', '83', '企业团餐', null, '1', 'admin', '2018-03-30 14:30:18', null, null, null, null, null, null, null, null);
...
CREATE TABLE `tb_production_order_detail` (
  ...
  `PRODUCTION_ORDER_NO` varchar(255) DEFAULT NULL COMMENT '生产订单编号',
  `PRD_ID` bigint(20) DEFAULT NULL COMMENT '产品ID',
  `PRD_NO` varchar(255) DEFAULT NULL COMMENT '产品编号',
  `PRD_NAME` varchar(255) DEFAULT NULL COMMENT '产品名称',
  `PRD_TYPE_ID` bigint(20) DEFAULT NULL COMMENT '产品类型ID',
  `PRD_TYPE_NAME` varchar(255) DEFAULT NULL COMMENT '产品类型名称',
  `AMOUNT` varchar(255) DEFAULT NULL COMMENT '需求数量',
  `PRICE1` varchar(255) DEFAULT NULL COMMENT '定价',
  `PRICE2` varchar(255) DEFAULT NULL COMMENT '售价',
  `COST` decimal(10,2) DEFAULT NULL COMMENT '成本',
  `REVENUE` varchar(255) DEFAULT NULL COMMENT '预估收入',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8 COMMENT='生产订单明细信息';

-- ----------------------------
-- Records of tb_production_order_detail
-- ----------------------------
INSERT INTO `tb_production_order_detail` VALUES ('70', '32', null, '55', '00000055', '热干面', '79', '面类', '33', '3.5', '3.5', '1.25', '115.50');
INSERT INTO `tb_production_order_detail` VALUES ('71', '32', null, '2062', 'F010602061', '测试类产品', '79', '面类', '90', '4', '7.5', '1.44', '675.00');
INSERT INTO `tb_production_order_detail` VALUES ('72', '1', null, '5', '00000001', '三彩蛋卷', '111', '饭卷', '100', '1.20', '1.2', '4.14', '120.00');
INSERT INTO `tb_production_order_detail` VALUES ('73', '2', null, '5', '00000001', '*三彩蛋卷', '111', '饭卷', '5', '1.20', '1.2', '4.14', '6.00');
INSERT INTO `tb_production_order_detail` VALUES ('74', '3', null, '5', '00000001', '*三彩蛋卷', '111', '饭卷', '5', '1.20', '1.2', '4.14', '6.00');
INSERT INTO `tb_production_order_detail` VALUES ('75', '3', null, '621', '00000645', '现打中餐-酸辣大包菜', '45', '米饭类', '5', '6.39', '6.39', '1.86', '31.95');
INSERT INTO `tb_production_order_detail` VALUES ('76', '4', null, '55', '00000055', '热干面', '79', '面类', '100', '3.5', '3.5', '1.48', '350.00');
...
CREATE TABLE `tb_production_plan` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `PLAN_NO` varchar(255) DEFAULT NULL COMMENT '计划编号',
  `PLAN_SORT_NO` int(11) DEFAULT NULL COMMENT '序号',
  `PLAN_COMPLETION_RATE` varchar(255) DEFAULT NULL COMMENT '完成率',
  `CREATE_DATE` datetime DEFAULT NULL COMMENT '创建日期',
  `CREATE_USER` varchar(255) DEFAULT NULL COMMENT '创建人',
  `STATUS` varchar(255) DEFAULT NULL COMMENT '状态',
  `REMARK` varchar(255) DEFAULT NULL COMMENT '备注',
  `PRD_COST` varchar(255) DEFAULT NULL COMMENT '成本',
  `PRD_INCOME` varchar(255) DEFAULT NULL COMMENT '收入',
  `DISCOUNT_INCOME` varchar(255) DEFAULT NULL COMMENT '折后收入',
  `DISCOUNT_COST_RATE` varchar(255) DEFAULT NULL COMMENT '折扣成本比',
  `PRD_MOUNT` varchar(255) DEFAULT NULL COMMENT '产品总数',
  `COST_RATE` varchar(255) DEFAULT NULL COMMENT '成本率',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='生产计划';
...
CREATE TABLE `tb_production_plan_detail` (
  ...
  `PRD_ID` bigint(20) DEFAULT NULL COMMENT '产品ID',
  `PRD_COST` varchar(255) DEFAULT NULL COMMENT '产品成本',
  `AMOUNT` varchar(255) DEFAULT NULL COMMENT '数量',
  `PRICE1` varchar(255) DEFAULT NULL COMMENT '定价',
  `PRICE2` varchar(255) DEFAULT NULL COMMENT '售价',
  `INCOME` varchar(255) DEFAULT NULL COMMENT '预估收入=（数量*定价）',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='生产计划明细';

-- ----------------------------
-- Records of tb_production_plan_detail
-- ----------------------------
...
CREATE TABLE `tb_quotation` (
  ...
  `suppier_id` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `mtr_id` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `current_price` decimal(10,0) DEFAULT NULL COMMENT '本次报价',
  `last_price` decimal(10,0) DEFAULT NULL COMMENT '上次报价',
  `operation_user` varchar(255) DEFAULT NULL COMMENT '操作员'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='供应商原料报价信息';
...
CREATE TABLE `tb_suppier_mtr` (
  ...
  `suppier_id` bigint(20) DEFAULT NULL COMMENT '供应商ID',
  `mtr_id` bigint(20) DEFAULT NULL COMMENT '原料ID',
  `mtr_extend_id` bigint(20) DEFAULT NULL COMMENT '采购规格Id，为0则使用默认规格，否则取规格扩展表信息',
  `mtr_extend_desc` varchar(255) DEFAULT NULL,
  `purchase_no` varchar(255) DEFAULT NULL COMMENT '采购编码',
  `price` decimal(10,2) unsigned DEFAULT NULL COMMENT '采购价',
  `status` varchar(255) DEFAULT NULL COMMENT '状态',
  `last_edit_user` varchar(255) DEFAULT NULL COMMENT '上次编辑人',
  `last_edit_date` datetime DEFAULT NULL COMMENT '上次编辑状态',
  `create_user` varchar(255) DEFAULT NULL,
  `create_date` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='供应商供应产品信息表';
...
INSERT INTO `tb_suppier_mtr` VALUES ('26', '9', '609', '0', '件-5000.000-¥:0.070', 'BC000096', '0.07', '1', 'admin', '2018-01-17 04:50:27', 'admin', '2017-12-18 23:37:54');
...
CREATE TABLE `tb_supplier_info` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `suppier_name` varchar(255) DEFAULT NULL COMMENT '供应商名称',
  `suppier_code` varchar(255) DEFAULT NULL COMMENT '供应商代码',
  `suppier_short_name` varchar(255) DEFAULT NULL COMMENT '供应商简称',
  `suppier_py` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `link_man` varchar(255) DEFAULT NULL COMMENT '联系人',
  `link_phone` varchar(255) DEFAULT NULL COMMENT '联系电话',
  `link_tell` varchar(255) DEFAULT NULL COMMENT '固定电话',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `tax_rate` varchar(255) DEFAULT NULL COMMENT '税率',
  `payment_days` varchar(255) DEFAULT NULL COMMENT '账期',
  `status` varchar(255) DEFAULT NULL COMMENT '状态',
  `create_user` varchar(255) DEFAULT NULL COMMENT '创建人',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `create_date` datetime DEFAULT NULL,
  ...
  `update_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='供应商信息表';

-- ----------------------------
-- Records of tb_supplier_info
-- ----------------------------
INSERT INTO `tb_supplier_info` VALUES ('4', '苏州丰连实业有限公司', '001', '苏州丰连实业', 'SZFLSYYXGS', '小张', '1234567890', null, null, '17', '30', '1', null, null, null, null, null);
INSERT INTO `tb_supplier_info` VALUES ('5', '大阪希琳阁印刷(苏州)有限公司上海分公司', '002', '大阪希琳阁', 'DBXLGYS(SZ)YXGSSHFGS', '黄银姣', '13501883661', 'QQ:2959899219', 'huang_yinjiao@osp-china.com.cn', '17', '30', '1', null, null, null, null, null);
INSERT INTO `tb_supplier_info` VALUES ('7', '武汉谷田种养殖专业合作社', '003', '武汉谷田种养殖', 'WHGTZYZZYHZS', '123', '123456', '027-222222', null, '11', '30', '1', null, null, null, null, null);
INSERT INTO `tb_supplier_info` VALUES ('8', '河南尚品食品有限公司', '004', '河南尚品食品', 'HNSPSPYXGS', '周明敬', '15038090657', '微信：wuyuepeople', null, '17', '30', '1', null, null, null, null, null);
INSERT INTO `tb_supplier_info` VALUES ('9', '武汉中粮集团', '005', '中粮', 'WHZLJT', null, null, null, null, '17', '30', '1', 'admin', null, '2017-12-16 12:37:32', 'admin', '2017-12-19 11:28:54');
...
CREATE TABLE `tb_type_data` (
  `ID` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `DATA_CODE` varchar(255) DEFAULT NULL COMMENT '类型数据编码',
  `DATA_NAME` varchar(255) DEFAULT NULL COMMENT '类型数据名称',
  `TYPE_ID` bigint(20) DEFAULT NULL COMMENT '所属分类',
  `DATA_PY` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `STATUS` int(11) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='类型数据信息';
...
CREATE TABLE `tb_type_info` (
  ...
  `TYPE_PY` varchar(255) DEFAULT NULL COMMENT '拼音码',
  `STATUS` int(11) DEFAULT NULL COMMENT '状态',
  `CREATE_USER` varchar(255) DEFAULT NULL,
  `CREATE_DATE` datetime DEFAULT NULL,
  `UPDATE_USER` varchar(255) DEFAULT NULL,
  `UPDATE_DATE` datetime DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 COMMENT='类型信息表';
